...
class Truck extends LogisticCompany {
    public Truck(){
        ...
        description.add("Company expense and cost of transportation: 386000 USD");
    }
}
...
class Airplane extends LogisticCompany {
    public Airplane(){
        ...
        description.add("Company expense and cost of transportation: 9780000 USD");
    }
}
...
class Ship extends LogisticCompany {
    public Ship(){
        ...
        description.add("Company expense and cost of transportation: 7800000 USD");
    }
}
